!(function (t, e) {
  ...
  var B = "secondTenths",
    ...
    Q = { secondTenths: 10, seconds: 60, minutes: 60, hours: 24 },
    W =
  ...
  function o() {
    ...
    function w(t, e) {
      ...
      return (
        (o = C(t, N[(n = e)])),
        (h[n] = o),
        (l[n] = n === J ? o : 0 <= o ? Z(o, Q[n]) : Q[n] - Z(o, Q[n])),
        h[e] !== r
      );
    }
    function t() {
      g(),
        (function () {
          for (var t in l)
            l.hasOwnProperty(t) && "number" == typeof l[t] && (l[t] = 0);
          for (var e in h)
            h.hasOwnProperty(e) && "number" == typeof h[e] && (h[e] = 0);
        })();
    }
    function g() {
    ...
    function O(t) {
      I() ? ((a = E()), (s = V(i.target))) : D(t),
        (function () {
          var t = N[n];
          if (S(P(Date.now()))) return;
          (e = setInterval(j, t)), (v = !0), (y = !1);
        })();
    }
    function E() {
      return P(Date.now()) - h.secondTenths * N[B] * r;
    }
    function j() {
      var t = P(Date.now());
      !(function (t) {
        t[B] && M("secondTenthsUpdated", b);
        t[F] && M("secondsUpdated", b);
        t[G] && M("minutesUpdated", b);
        t[H] && M("hoursUpdated", b);
        t[J] && M("daysUpdated", b);
      })(T()),
        o(b.detail.timer),
        S(t) && (U(), M("targetAchieved", b));
    }
    function T(t) {
    ...
    function D(t) {
      ...
      (n = (function (t) {
        ...
        (o = "function" == typeof t.callback ? t.callback : function () {}),
        (c = !0 === t.countdown),
        (r = !0 == c ? -1 : 1),
        "object" === _(t.startValues)
          ? ((e = t.startValues),
            (u = x(e)),
            (l.secondTenths = u[0]),
            (l.seconds = u[1]),
        ...
        (m = {
          precision: n,
          callback: o,
          countdown: "object" === _(t) && !0 === t.countdown,
          target: s,
          startValues: u,
        }),
        (i = t);
    ...
    function V(t) {
      if (t) {
        var e = L((s = x(t)));
        return (f = a + e.secondTenths * N[B] * r), s;
      }
    }
    function L(t, e) {
      var n = e || {};
    ...
    function k(t, e) {
      X() ? p.addEventListener(t, e) : Y() && p.on(t, e);
    }
    function A(t, e) {
      X() ? p.removeEventListener(t, e) : Y() && p.removeListener(t, e);
    }
    function M(t, e) {
      X() ? p.dispatchEvent(new CustomEvent(t, e)) : Y() && p.emit(t, e);
    }
    function q() {
      return v;
    }
